...
/* Jasmine Matchers
describe('describing something',function(){
  it('does something',function(){
    ...
    expect(a).toBeFalsy();
    expect(a).toContain("bar"); //for finding an item in an array
    expect(e).toBeLessThan(pi); //The 'toBeLessThan' matcher is for mathematical comparisons
    expect(pi).toBeGreaterThan(e);
    expect(pi).not.toBeCloseTo(e, 2); // The 'toBeCloseTo' matcher is for precision math comparison
    expect(bar).toThrow(); // The 'toThrow' matcher is for testing if a function throws an exception
  });
});
*/
